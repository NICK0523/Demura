...
ca410_data=r'E:\V161\L4A\CA410\GammaMeasData_6A0913.csv'

#ca410_data=r'D:\UserShare\temp\V161\20230530\4A1913\GammaMeasData_4A1913.csv'
#rr,gg,bb=calibrate_color_ratio_XYZ_model_Wcal(ca410_data,600,0.30,0.31)
rr,gg,bb,dg=calibrate_color_ratio_XYZ_model(ca410_data,650,0.30,0.31)
...
for i in ca410_file:
    if i.startswith('GammaMeasData'):
        ...
        R,G,B=output_DG(save_path,file_name,path,rr,gg,bb)
